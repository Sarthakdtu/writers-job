...
define(['./workbox-d90baac9'], (function (workbox) { 'use strict';
  ...
  workbox.registerRoute(/^\/api\/stories\/[^/]+\/assets\//, new workbox.NetworkOnly(), 'GET');
  ...
  workbox.registerRoute(/^https:\/\/fonts\.gstatic\.com/, new workbox.StaleWhileRevalidate({
